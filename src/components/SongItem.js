...
const SongItem = ({ thumbnail, artistsNames, title, releaseDate, sid }) => {
  ...
  return (
    <div
      ...
      className="w-[45%] min-[1024px]:w-[30%] flex items-center gap-[10px] flex-auto p-[10px] hover:bg-main-200 rounded-md cursor-pointer"
    >
